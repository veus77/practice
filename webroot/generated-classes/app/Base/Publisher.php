...
abstract class Publisher implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\app\\Map\\PublisherTableMap';
    ...
    /**
     * Initializes internal state of app\Base\Publisher object.
     */
     ...
     * @return $this|\app\Publisher The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\app\\Publisher'), 0, $e);
        }
    }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\app\Publisher The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \app\Publisher (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \app\Publisher Clone of current object.
     * @throws PropelException
     */
    ...
    public function setBook(ChildBook $v = null)
    {
        ...
        if ($v !== null && $v->getPublisher(null, false) === null) {
            $v->setPublisher($this);
        }
