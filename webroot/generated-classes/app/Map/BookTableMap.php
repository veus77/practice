...
class BookTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'app.Map.BookTableMap';
     ...
     */
    const OM_CLASS = '\\app\\Book';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'app.Book';
     ...
     */
    const COL_LAST_NAME = 'book.last_name';

    /**
     * the column name for the age field
     */
    const COL_AGE = 'book.age';

    /**
     * the column name for the developer field
     */
    const COL_DEVELOPER = 'book.developer';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Name', 'LastName', 'Age', 'Developer', ),
        self::TYPE_CAMELNAME     => array('id', 'name', 'lastName', 'age', 'developer', ),
        self::TYPE_COLNAME       => array(BookTableMap::COL_ID, BookTableMap::COL_NAME, BookTableMap::COL_LAST_NAME, BookTableMap::COL_AGE, BookTableMap::COL_DEVELOPER, ),
        self::TYPE_FIELDNAME     => array('id', 'name', 'last_name', 'age', 'developer', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Name' => 1, 'LastName' => 2, 'Age' => 3, 'Developer' => 4, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'name' => 1, 'lastName' => 2, 'age' => 3, 'developer' => 4, ),
        self::TYPE_COLNAME       => array(BookTableMap::COL_ID => 0, BookTableMap::COL_NAME => 1, BookTableMap::COL_LAST_NAME => 2, BookTableMap::COL_AGE => 3, BookTableMap::COL_DEVELOPER => 4, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'name' => 1, 'last_name' => 2, 'age' => 3, 'developer' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\app\\Book');
        $this->setPackage('app');
        $this->setUseIdGenerator(true);
        // columns
        $this->addForeignPrimaryKey('id', 'Id', 'INTEGER' , 'publisher', 'id', true, null, null);
        $this->addForeignPrimaryKey('id', 'Id', 'INTEGER' , 'car', 'id', true, null, null);
        $this->addColumn('name', 'Name', 'VARCHAR', true, 32, null);
        $this->addColumn('last_name', 'LastName', 'VARCHAR', true, 32, null);
        $this->addColumn('age', 'Age', 'INTEGER', true, null, null);
        $this->addColumn('developer', 'Developer', 'INTEGER', true, 32, null);
    } // initialize()
    ...
    {
        $this->addRelation('Publisher', '\\app\\Publisher', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':id',
    1 => ':id',
        ...
        $this->addRelation('Car', '\\app\\Car', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':id',
    1 => ':id',
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(BookTableMap::COL_LAST_NAME);
            $criteria->addSelectColumn(BookTableMap::COL_AGE);
            $criteria->addSelectColumn(BookTableMap::COL_DEVELOPER);
        } else {
            $criteria->addSelectColumn($alias . '.id');
            $criteria->addSelectColumn($alias . '.name');
            $criteria->addSelectColumn($alias . '.last_name');
            $criteria->addSelectColumn($alias . '.age');
            $criteria->addSelectColumn($alias . '.developer');
        }
    }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \app\Book) { // it's a model object
