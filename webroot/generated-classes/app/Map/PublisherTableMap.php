...
class PublisherTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'app.Map.PublisherTableMap';
     ...
     */
    const OM_CLASS = '\\app\\Publisher';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'app.Publisher';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\app\\Publisher');
        $this->setPackage('app');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \app\Publisher) { // it's a model object
